 ...
 * analysis is needed.
 */
static padloc_symbol_mode_t padloc_symbol_mode = PLC_SYMBOL_DEFAULT;
 ...
 */
void set_client_mode(padloc_symbol_mode_t mode){
    padloc_symbol_mode = mode;
}
