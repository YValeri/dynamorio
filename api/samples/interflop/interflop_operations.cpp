...
/*
 * This function, given a instruction, gets the opcode and match it with an
 * OPERATION_CATEGORY, according to the rules and flags defined in ./interflop_operations.hpp.
*/
enum OPERATION_CATEGORY ifp_get_operation_category(instr_t* instr)
{
    switch(instr_get_opcode(instr))
    {
        ...
        // TODO : complete with according operations
