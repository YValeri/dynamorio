...
#define IFP_OP_SSE  131072	 //0b0100000000000000000
#define IFP_OP_AVX 	262144	 //0b1000000000000000000
...
enum OPERATION_CATEGORY{
	...
	IFP_ADDS_SSE = IFP_OP_FLOAT | IFP_OP_SCALAR | IFP_OP_ADD | IFP_OP_SSE, 
	IFP_SUBS_SSE = IFP_OP_FLOAT | IFP_OP_SCALAR | IFP_OP_SUB | IFP_OP_SSE, 
	IFP_MULS_SSE = IFP_OP_FLOAT | IFP_OP_SCALAR | IFP_OP_MUL | IFP_OP_SSE, 
	IFP_DIVS_SSE = IFP_OP_FLOAT | IFP_OP_SCALAR | IFP_OP_DIV | IFP_OP_SSE, 

	// Scalar Float AVX instructions 
	IFP_ADDS_AVX = IFP_OP_FLOAT | IFP_OP_SCALAR | IFP_OP_ADD | IFP_OP_AVX, 
	IFP_SUBS_AVX = IFP_OP_FLOAT | IFP_OP_SCALAR | IFP_OP_SUB | IFP_OP_AVX, 
	IFP_MULS_AVX = IFP_OP_FLOAT | IFP_OP_SCALAR | IFP_OP_MUL | IFP_OP_AVX, 
	IFP_DIVS_AVX = IFP_OP_FLOAT | IFP_OP_SCALAR | IFP_OP_DIV | IFP_OP_AVX, 

	// Scalar Double SSE instructions 
	IFP_ADDD_SSE = IFP_OP_DOUBLE | IFP_OP_SCALAR | IFP_OP_ADD | IFP_OP_SSE, 
	IFP_SUBD_SSE = IFP_OP_DOUBLE | IFP_OP_SCALAR | IFP_OP_SUB | IFP_OP_SSE, 
	IFP_MULD_SSE = IFP_OP_DOUBLE | IFP_OP_SCALAR | IFP_OP_MUL | IFP_OP_SSE, 
	IFP_DIVD_SSE = IFP_OP_DOUBLE | IFP_OP_SCALAR | IFP_OP_DIV | IFP_OP_SSE, 

	// Scalar Double AVX instructions 
	IFP_ADDD_AVX = IFP_OP_DOUBLE | IFP_OP_SCALAR | IFP_OP_ADD | IFP_OP_AVX, 
	IFP_SUBD_AVX = IFP_OP_DOUBLE | IFP_OP_SCALAR | IFP_OP_SUB | IFP_OP_AVX, 
	IFP_MULD_AVX = IFP_OP_DOUBLE | IFP_OP_SCALAR | IFP_OP_MUL | IFP_OP_AVX, 
	IFP_DIVD_AVX = IFP_OP_DOUBLE | IFP_OP_SCALAR | IFP_OP_DIV | IFP_OP_AVX, 
	...
	// Packed float SSE 
	IFP_PADDS_SSE = IFP_OP_FLOAT | IFP_OP_PACKED | IFP_OP_ADD | IFP_OP_SSE, 
	IFP_PSUBS_SSE = IFP_OP_FLOAT | IFP_OP_PACKED | IFP_OP_SUB | IFP_OP_SSE, 
	IFP_PMULS_SSE = IFP_OP_FLOAT | IFP_OP_PACKED | IFP_OP_MUL | IFP_OP_SSE, 
	IFP_PDIVS_SSE = IFP_OP_FLOAT | IFP_OP_PACKED | IFP_OP_DIV | IFP_OP_SSE, 
	
	//Packed double SSE
	IFP_PADDD_SSE = IFP_OP_DOUBLE | IFP_OP_PACKED | IFP_OP_ADD | IFP_OP_SSE, 
	IFP_PSUBD_SSE = IFP_OP_DOUBLE | IFP_OP_PACKED | IFP_OP_SUB | IFP_OP_SSE, 
	IFP_PMULD_SSE = IFP_OP_DOUBLE | IFP_OP_PACKED | IFP_OP_MUL | IFP_OP_SSE, 
	IFP_PDIVD_SSE = IFP_OP_DOUBLE | IFP_OP_PACKED | IFP_OP_DIV | IFP_OP_SSE, 

	// Packed float AVX 
	IFP_PADDS_AVX = IFP_OP_FLOAT | IFP_OP_PACKED | IFP_OP_ADD | IFP_OP_AVX, 
	IFP_PSUBS_AVX = IFP_OP_FLOAT | IFP_OP_PACKED | IFP_OP_SUB | IFP_OP_AVX, 
	IFP_PMULS_AVX = IFP_OP_FLOAT | IFP_OP_PACKED | IFP_OP_MUL | IFP_OP_AVX, 
	IFP_PDIVS_AVX = IFP_OP_FLOAT | IFP_OP_PACKED | IFP_OP_DIV | IFP_OP_AVX, 
	
	//Packed double AVX
	IFP_PADDD_AVX = IFP_OP_DOUBLE | IFP_OP_PACKED | IFP_OP_ADD | IFP_OP_AVX, 
	IFP_PSUBD_AVX = IFP_OP_DOUBLE | IFP_OP_PACKED | IFP_OP_SUB | IFP_OP_AVX, 
	IFP_PMULD_AVX = IFP_OP_DOUBLE | IFP_OP_PACKED | IFP_OP_MUL | IFP_OP_AVX, 
	IFP_PDIVD_AVX = IFP_OP_DOUBLE | IFP_OP_PACKED | IFP_OP_DIV | IFP_OP_AVX, 
	...
	IFP_PADDS_SSE_128 = IFP_PADDS_SSE | IFP_OP_128, 
	IFP_PSUBS_SSE_128 = IFP_PSUBS_SSE | IFP_OP_128, 
	IFP_PMULS_SSE_128 = IFP_PMULS_SSE | IFP_OP_128, 
	IFP_PDIVS_SSE_128 = IFP_PDIVS_SSE | IFP_OP_128, 
	
	// Packed float 128 bits AVX
	IFP_PADDS_AVX_128 = IFP_PADDS_AVX | IFP_OP_128, 
	IFP_PSUBS_AVX_128 = IFP_PSUBS_AVX | IFP_OP_128, 
	IFP_PMULS_AVX_128 = IFP_PMULS_AVX | IFP_OP_128, 
	IFP_PDIVS_AVX_128 = IFP_PDIVS_AVX | IFP_OP_128, 
	
	// Packed double 128 bits SSE
	IFP_PADDD_SSE_128 = IFP_PADDD_SSE | IFP_OP_128, 
	IFP_PSUBD_SSE_128 = IFP_PSUBD_SSE | IFP_OP_128, 
	IFP_PMULD_SSE_128 = IFP_PMULD_SSE | IFP_OP_128, 
	IFP_PDIVD_SSE_128 = IFP_PDIVD_SSE | IFP_OP_128, 

	// Packed double 128 bits AVX
	IFP_PADDD_AVX_128 = IFP_PADDD_AVX | IFP_OP_128, 
	IFP_PSUBD_AVX_128 = IFP_PSUBD_AVX | IFP_OP_128, 
	IFP_PMULD_AVX_128 = IFP_PMULD_AVX | IFP_OP_128, 
	IFP_PDIVD_AVX_128 = IFP_PDIVD_AVX | IFP_OP_128, 
	...
	IFP_PADDS_256 = IFP_PADDS_AVX | IFP_OP_256, 
	IFP_PSUBS_256 = IFP_PSUBS_AVX | IFP_OP_256, 
	IFP_PMULS_256 = IFP_PMULS_AVX | IFP_OP_256, 
	IFP_PDIVS_256 = IFP_PDIVS_AVX | IFP_OP_256, 
	
	//Packed double 256 bits
	IFP_PADDD_256 = IFP_PADDD_AVX | IFP_OP_256, 
	IFP_PSUBD_256 = IFP_PSUBD_AVX | IFP_OP_256, 
	IFP_PMULD_256 = IFP_PMULD_AVX | IFP_OP_256, 
	IFP_PDIVD_256 = IFP_PDIVD_AVX | IFP_OP_256, 
	...
	IFP_PADDS_512 = IFP_PADDS_AVX | IFP_OP_512, 
	IFP_PSUBS_512 = IFP_PSUBS_AVX | IFP_OP_512, 
	IFP_PMULS_512 = IFP_PMULS_AVX | IFP_OP_512, 
	IFP_PDIVS_512 = IFP_PDIVS_AVX | IFP_OP_512, 
	
	// Packed double 512 bits
	IFP_PADDD_512 = IFP_PADDD_AVX | IFP_OP_512, 
	IFP_PSUBD_512 = IFP_PSUBD_AVX | IFP_OP_512, 
	IFP_PMULD_512 = IFP_PMULD_AVX | IFP_OP_512, 
	IFP_PDIVD_512 = IFP_PDIVD_AVX | IFP_OP_512, 
	...
	IFP_A132SS = IFP_OP_FLOAT | IFP_OP_SCALAR | IFP_OP_FMA | IFP_OP_132 | IFP_OP_AVX, 
	IFP_A213SS = IFP_OP_FLOAT | IFP_OP_SCALAR | IFP_OP_FMA | IFP_OP_213 | IFP_OP_AVX, 
	IFP_A231SS = IFP_OP_FLOAT | IFP_OP_SCALAR | IFP_OP_FMA | IFP_OP_231 | IFP_OP_AVX, 
	IFP_S132SS = IFP_OP_FLOAT | IFP_OP_SCALAR | IFP_OP_FMS | IFP_OP_132 | IFP_OP_AVX, 
	IFP_S213SS = IFP_OP_FLOAT | IFP_OP_SCALAR | IFP_OP_FMS | IFP_OP_213 | IFP_OP_AVX, 
	IFP_S231SS = IFP_OP_FLOAT | IFP_OP_SCALAR | IFP_OP_FMS | IFP_OP_231 | IFP_OP_AVX, 

	//Scalar FMA and FMS Double
	IFP_A132SD = IFP_OP_DOUBLE | IFP_OP_SCALAR | IFP_OP_FMA | IFP_OP_132 | IFP_OP_AVX, 
	IFP_A213SD = IFP_OP_DOUBLE | IFP_OP_SCALAR | IFP_OP_FMA | IFP_OP_213 | IFP_OP_AVX, 
	IFP_A231SD = IFP_OP_DOUBLE | IFP_OP_SCALAR | IFP_OP_FMA | IFP_OP_231 | IFP_OP_AVX, 
	IFP_S132SD = IFP_OP_DOUBLE | IFP_OP_SCALAR | IFP_OP_FMS | IFP_OP_132 | IFP_OP_AVX, 
	IFP_S213SD = IFP_OP_DOUBLE | IFP_OP_SCALAR | IFP_OP_FMS | IFP_OP_213 | IFP_OP_AVX, 
	IFP_S231SD = IFP_OP_DOUBLE | IFP_OP_SCALAR | IFP_OP_FMS | IFP_OP_231 | IFP_OP_AVX, 

	//Packed FMA and FMS Float
	IFP_A132PS = IFP_OP_FLOAT | IFP_OP_PACKED | IFP_OP_FMA | IFP_OP_132 | IFP_OP_AVX, 
	IFP_A213PS = IFP_OP_FLOAT | IFP_OP_PACKED | IFP_OP_FMA | IFP_OP_213 | IFP_OP_AVX, 
	IFP_A231PS = IFP_OP_FLOAT | IFP_OP_PACKED | IFP_OP_FMA | IFP_OP_231 | IFP_OP_AVX, 
	IFP_S132PS = IFP_OP_FLOAT | IFP_OP_PACKED | IFP_OP_FMS | IFP_OP_132 | IFP_OP_AVX, 
	IFP_S213PS = IFP_OP_FLOAT | IFP_OP_PACKED | IFP_OP_FMS | IFP_OP_213 | IFP_OP_AVX, 
	IFP_S231PS = IFP_OP_FLOAT | IFP_OP_PACKED | IFP_OP_FMS | IFP_OP_231 | IFP_OP_AVX, 

	//Packed FMA and FMS Double
	IFP_A132PD = IFP_OP_DOUBLE | IFP_OP_PACKED | IFP_OP_FMA | IFP_OP_132 | IFP_OP_AVX, 
	IFP_A213PD = IFP_OP_DOUBLE | IFP_OP_PACKED | IFP_OP_FMA | IFP_OP_213 | IFP_OP_AVX, 
	IFP_A231PD = IFP_OP_DOUBLE | IFP_OP_PACKED | IFP_OP_FMA | IFP_OP_231 | IFP_OP_AVX, 
	IFP_S132PD = IFP_OP_DOUBLE | IFP_OP_PACKED | IFP_OP_FMS | IFP_OP_132 | IFP_OP_AVX, 
	IFP_S213PD = IFP_OP_DOUBLE | IFP_OP_PACKED | IFP_OP_FMS | IFP_OP_213 | IFP_OP_AVX, 
	IFP_S231PD = IFP_OP_DOUBLE | IFP_OP_PACKED | IFP_OP_FMS | IFP_OP_231 | IFP_OP_AVX, 
